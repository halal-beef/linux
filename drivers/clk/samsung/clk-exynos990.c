...
static const struct samsung_gate_clock hsi1_gate_clks[] __initconst = {
	GATE(CLK_GOUT_HSI1_PCIE_PHY_REFCLK,
	     "gout_hsi1_pcie_phy_refclk", "mout_hsi1_pcie_user",
	     CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN2_IPCLKPORT_PHY_REFCLK_IN,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_PCIE_GEN4_PHY_REFCLK,
	     "gout_hsi1_pcie_gen4_phy_refclk", "mout_hsi1_pcie_user",
	     CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN4_0_IPCLKPORT_PCIE_001_PCIE_SUB_CTRL_INST_0_PHY_REFCLK_IN,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_D_TZPC_PCLK,
	     "gout_hsi1_d_tzpc_pclk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_D_TZPC_HSI1_IPCLKPORT_PCLK,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_GPIO_PCLK,
	     "gout_hsi1_gpio_pclk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_GPIO_HSI1_IPCLKPORT_PCLK,
	     21, CLK_IGNORE_UNUSED, 0),
	GATE(CLK_GOUT_HSI1_CMU_PCLK,
	     "gout_hsi1_cmu_pclk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_HSI1_CMU_HSI1_IPCLKPORT_PCLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_HSI1_LHM_AXI_P_CLK,
	     "gout_hsi1_lhm_axi_p_clk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_LHM_AXI_P_HSI1_IPCLKPORT_I_CLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_HSI1_LHS_ACEL_D_CLK,
	     "gout_hsi1_lhs_acel_d_clk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_LHS_ACEL_D_HSI1_IPCLKPORT_I_CLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_HSI1_MMC_CARD_I_ACLK,
	     "gout_hsi1_mmc_card_i_aclk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_MMC_CARD_IPCLKPORT_I_ACLK,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_MMC_CARD_SDCLKIN,
	     "gout_hsi1_mmc_card_sdclkin", "mout_hsi1_mmc_card_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_MMC_CARD_IPCLKPORT_SDCLKIN,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_PCIE_DBI_ACLK,
	     "gout_hsi1_pcie_dbi_aclk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_PCIE_GEN2_IPCLKPORT_DBI_ACLK,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_PCIE_GEN2_APB_PCLK,
	     "gout_hsi1_pcie_gen2_apb_pclk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_PCIE_GEN2_IPCLKPORT_IEEE1500_WRAPPER_FOR_PCIEG2_PHY_X1_INST_0_I_SCL_APB_PCLK,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_PCIE_MSTR_ACLK,
	     "gout_hsi1_pcie_mstr_aclk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_PCIE_GEN2_IPCLKPORT_MSTR_ACLK,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_PCIE_APB_CLK,
	     "gout_hsi1_pcie_apb_clk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_PCIE_GEN2_IPCLKPORT_PCIE_SUB_CTRL_INST_0_I_DRIVER_APB_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_PCIE_PIPE_PCLK,
	     "gout_hsi1_pcie_pipe_pclk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_PCIE_GEN2_IPCLKPORT_PIPE2_DIGITAL_X1_WRAP_INST_0_I_APB_PCLK_SCL,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_PCIE_SLV_ACLK,
	     "gout_hsi1_pcie_slv_aclk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_PCIE_GEN2_IPCLKPORT_SLV_ACLK,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_PCIE_GEN4_DBI_ACLK,
	     "gout_hsi1_pcie_gen4_dbi_aclk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_PCIE_GEN4_0_IPCLKPORT_PCIE_001_G4X2_DWC_PCIE_CTL_INST_0_DBI_ACLK_UG,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_PCIE_GEN4_MSTR_ACLK,
	     "gout_hsi1_pcie_gen4_mstr_aclk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_PCIE_GEN4_0_IPCLKPORT_PCIE_001_G4X2_DWC_PCIE_CTL_INST_0_MSTR_ACLK_UG,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_PCIE_GEN4_SLV_ACLK,
	     "gout_hsi1_pcie_gen4_slv_aclk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_PCIE_GEN4_0_IPCLKPORT_PCIE_001_G4X2_DWC_PCIE_CTL_INST_0_SLV_ACLK_UG,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_PCIE_GEN4_APB_CLK,
	     "gout_hsi1_pcie_gen4_apb_clk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_PCIE_GEN4_0_IPCLKPORT_PCIE_001_PCIE_SUB_CTRL_INST_0_I_DRIVER_APB_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_PCIE_GEN4_PIPE_PCLK,
	     "gout_hsi1_gen4_pipe_pclk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_PCIE_GEN4_0_IPCLKPORT_PCS_PMA_INST_0_PIPE_PAL_PCIE_INST_0_I_APB_PCLK,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_PCIE_GEN4_SF_APB_PCLK,
	     "gout_hsi1_pcie_gen4_sf_apb_pclk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_PCIE_GEN4_0_IPCLKPORT_PCS_PMA_INST_0_SF_PCIEPHY000X2_LN07LPP_QCH_TM_WRAPPER_INST_0_I_APB_PCLK,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_PCIE_IA_GEN2_CLK,
	     "gout_hsi1_pcie_ia_gen2_clk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_PCIE_IA_GEN2_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_PCIE_IA_GEN4_CLK,
	     "gout_hsi1_pcie_ia_gen4_clk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_PCIE_IA_GEN4_0_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_PPMU_ACLK,
	     "gout_hsi1_ppmu_aclk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_PPMU_HSI1_IPCLKPORT_ACLK,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_PPMU_PCLK,
	     "gout_hsi1_ppmu_pclk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_PPMU_HSI1_IPCLKPORT_PCLK,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_BUS_CLK,
	     "gout_hsi1_bus_clk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_RSTNSYNC_CLK_HSI1_BUS_IPCLKPORT_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_OSCCLK_CLK, "gout_hsi1_oscclk_clk",
	     "oscclk",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_RSTNSYNC_CLK_HSI1_OSCCLK_IPCLKPORT_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_SYSMMU_CLK,
	     "gout_hsi1_sysmmu_clk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_SYSMMU_HSI1_IPCLKPORT_CLK_S2,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_SYSREG_PCLK,
	     "gout_hsi1_sysreg_pclk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_SYSREG_HSI1_IPCLKPORT_PCLK,
	     21, CLK_IGNORE_UNUSED, 0),
	GATE(CLK_GOUT_HSI1_UFS_CARD_ACLK,
	     "gout_hsi1_ufs_card_aclk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_UFS_CARD_IPCLKPORT_I_ACLK,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_UFS_CARD_CLK, "gout_hsi1_ufs_card_clk",
	     "mout_hsi1_ufs_card_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_UFS_CARD_IPCLKPORT_I_CLK_UNIPRO,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_UFS_CARD_FMP_CLK,
	     "gout_hsi1_ufs_card_fmp_clk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_UFS_CARD_IPCLKPORT_I_FMP_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_UFS_EMBD_ACLK,
	     "gout_hsi1_ufs_embd_aclk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_UFS_EMBD_IPCLKPORT_I_ACLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_HSI1_UFS_EMBD_UNIPRO,
	     "gout_hsi1_ufs_embd_unipro", "mout_hsi1_ufs_embd_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_UFS_EMBD_IPCLKPORT_I_CLK_UNIPRO,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_HSI1_UFS_EMBD_FMP_CLK,
	     "gout_hsi1_ufs_embd_fmp_clk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_UFS_EMBD_IPCLKPORT_I_FMP_CLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_HSI1_VGEN_LITE_CLK,
	     "gout_hsi1_vgen_lite_clk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_VGEN_LITE_HSI1_IPCLKPORT_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI1_XIU_D_ACLK,
	     "gout_hsi1_xiu_d_aclk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_XIU_D_HSI1_IPCLKPORT_ACLK,
	     21, CLK_IGNORE_UNUSED, 0),
	GATE(CLK_GOUT_HSI1_XIU_P_ACLK,
	     "gout_hsi1_xiu_p_aclk", "mout_hsi1_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI1_UID_XIU_P_HSI1_IPCLKPORT_ACLK,
	     21, CLK_IGNORE_UNUSED, 0)
};
